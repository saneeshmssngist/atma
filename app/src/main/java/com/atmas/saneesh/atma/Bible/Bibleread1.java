...
public class Bibleread1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bibleread1);
    ...
    public class Pageradapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            webView.loadUrl("file:///android_asset/www/Bible/Biblepart1/biblepart"+(position+1)+".html");
            container.addView(v);
            return v;
        }
        @Override
