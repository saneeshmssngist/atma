...
public class Bibleread2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bibleread2);
    ...
    public class Pageradapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            webView.loadUrl("file:///android_asset/www/Bible/Biblepart2/biblepart"+(position+1)+".html");
            container.addView(v);
            return v;
        }
        @Override
